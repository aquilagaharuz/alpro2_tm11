...
def home():
    if request.method == 'POST':
        ...
        if name:
            ...
            return render_template('puja.html', welcome_message=welcome_message)
        else:
            return render_template('puja.html', welcome_message="Parameter 'nama' pada permintaan POST tidak ditemukan.")
